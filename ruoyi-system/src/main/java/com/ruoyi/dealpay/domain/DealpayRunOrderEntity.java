...
/**
 * 流水订单记录对象 dealpay_run_order
 *
 * @author kiwi
 * @date 2020-04-03
 */
public class DealpayRunOrderEntity extends BaseEntity {
     ...
     * 流水订单id(全局唯一索引)
     */
    @Excel(name = "流水订单id(全局唯一索引)")
    private String orderId;

    /**
     * 关联订单号(普通索引)
     */
    @Excel(name = "关联订单号(普通索引)")
     ...
     */
    @Excel(name = "流水类型(1充值交易,2系统加款,3交易手续费,4系统扣款,5代付,6代付手续费,7冻结,8解冻,9代付手手续费冻结,10代付冻结,11增加交易点数,12点数扣除,13代理商分润，14码商分润，17人工加点数，18人工减点数，19 卡商交易加钱，20下游商户交易加款，21下游商户交易手续费扣款)")
