...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://www.baidu.com?wd=哈哈|新年快乐||哈哈";
        //不含Logo
        //QRCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片名
        QRCodeUtil.encode(text, "D:\\Java\\otc-admin\\ruoyi-admin\\src\\main\\resources\\static\\img\\yuechuangLogo.png", "e:\\", "qrcode", true);
    }
